...
$maintUri = "$($orchestratorURL)/api/Maintenance/Start?phase=Suspended&killJobs=true";
Write-Host "Starting Maintenance - Suspended and Killing all jobs at $($maintUri)";
